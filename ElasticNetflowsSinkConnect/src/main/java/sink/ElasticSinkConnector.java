...
public class ElasticSinkConnector extends SinkConnector {
    ...
    // Elastic properties
    /**
     * Elastic indexes for netflow data. Two indexes are required for raw and
     * preprocessed netflow data. Comma separated.
     * Default: netflow-raw-index,netflow-preprocessed-index
     */
    public static final String ELASTIC_INDEXES = "elastic.indexes.netflow";
    /**
     * Elastic index for raw netflow data.
     * Default: netflow-raw-index
     */
    public static final String RAW_NETFLOW_ELASTIC_INDEX = "elastic.index.netflow.raw";
    /**
     * Elastic index for preprocessed netflow data.
     * Default: netflow-preprocessed-index
     */
    public static final String PREPROCESSED_NETFLOW_ELASTIC_INDEX = "elastic.index.netflow.preprocessed";
    /**
     ...
     * For netflow collection two topics are required, for both raw and
     * preprocessed netflow data. Topics will be comma separated.
     * Default: netflow-raw-connector,netflow-preprocessed-connector
     */
    public static final String KAFKA_SINK_TOPICS = "topics";
    /**
     * Kafka topic, where raw netflow data are ingested.
     * Default: netflow-raw-connector
     */
    public static final String RAW_NETFLOW_KAFKA_TOPIC = "kafka.topic.sink.netflow.raw";
    /**
     * Kafka topic, where preprocessed netflow data are ingested.
     * Default: netflow-preprocessed-connector
     */
    public static final String PREPROCESSED_NETFLOW_KAFKA_TOPIC = "kafka.topic.sink.netflow.preprocessed";
    /**
     * Flag, which controls if connector will also sink raw netflow data to Elastic or not.
     * Default: false
     */
    public static final String SINK_RAW_NETFLOW = "connector.sink.netflow.raw";

    /**
     * A variable that says if netflows will be integrated with Zeek tool.
     * If yes, different schema files will be used.
     */
    public static final String ZEEK_ENABLED = "zeek.enabled";
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
            ...
            .define(ELASTIC_INDEXES, ConfigDef.Type.STRING, "netflow-raw-index,netflow-preprocessed-index",
            ...
            .define(RAW_NETFLOW_ELASTIC_INDEX, ConfigDef.Type.STRING, "netflow-raw-index",
                    ConfigDef.Importance.HIGH, "Elastic index for raw netflow data", ELASTIC_PARAM_GROUP,
                    5, ConfigDef.Width.SHORT, "Elastic index for raw netflow data (required)")
            .define(PREPROCESSED_NETFLOW_ELASTIC_INDEX, ConfigDef.Type.STRING, "netflow-preprocessed-index",
                    ConfigDef.Importance.HIGH, "Elastic index for preprocessed netflow data",
                    ELASTIC_PARAM_GROUP, 6, ConfigDef.Width.SHORT,
                    "Elastic index for preprocessed netflow data (required)")
            ...
            .define(KAFKA_SINK_TOPICS, ConfigDef.Type.STRING,
                    "netflow-raw-connector,netflow-preprocessed-connector", ConfigDef.Importance.HIGH,
            ...
            .define(RAW_NETFLOW_KAFKA_TOPIC, ConfigDef.Type.STRING, "netflow-raw-connector",
            ...
            .define(PREPROCESSED_NETFLOW_KAFKA_TOPIC, ConfigDef.Type.STRING, "netflow-preprocessed-connector",
            ...
            .define(SINK_RAW_NETFLOW, ConfigDef.Type.STRING, "false", ConfigDef.Importance.HIGH,
                    "Sink raw netflow data or not", CONNECTOR_PARAM_GROUP, 0, ConfigDef.Width.SHORT,
                    "Sink raw netflow data or not (required).")
            .define(ZEEK_ENABLED, ConfigDef.Type.STRING, "false", ConfigDef.Importance.HIGH,
                    "Netflows will be integrated with Zeek (Default: false)", OTHER_PARAM_GROUP, 0, ConfigDef.Width.SHORT,
                    "Netflows will be integrated with Zeek (optional).")
            .define(BENCHMARK_MODE, ConfigDef.Type.STRING, "false", ConfigDef.Importance.HIGH,
                    "Run Kafka Source Connector in benchmark mode (Default: false)", OTHER_PARAM_GROUP, 1, ConfigDef.Width.SHORT,
